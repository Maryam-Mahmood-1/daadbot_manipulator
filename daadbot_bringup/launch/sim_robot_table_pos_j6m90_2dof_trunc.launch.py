...
def generate_launch_description():
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_desc, "launch", "gazebo_table_pos_j6m90_2dof_trunc.launch.py")
        )
    )

    controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_controller, "launch", "controller_table_pos_j6m90_2dof_trunc.launch.py")
        )
    )
