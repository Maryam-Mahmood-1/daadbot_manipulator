...
def generate_launch_description():
    ...
    xacro_file = os.path.join(pkg_desc, 'urdf/urdf_4dof_inverted_torque/daadbot.urdf.xacro')
    ...
    gazebo = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_desc, "launch", "gazebo_inverted_4dof_effort.launch.py")
        ),
    ...
    controller = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(pkg_controller, "launch", "effort_forw_controller_inverted_4dof.launch.py")
        ),
