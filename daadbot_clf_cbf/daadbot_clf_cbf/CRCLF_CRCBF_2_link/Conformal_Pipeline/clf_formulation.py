...
#         self.P = solve_continuous_are(self.F, self.G,
#                                       self.Q_mat,
#                                       self.R_mat)
...
#     def get_lyapunov_constraints(self,
#                                  x, dx,
#                                  x_des, dx_des,
#                                  q_quantile=0.0,
#                                  J=None):
...
#             robustness_cost = (
#                 np.linalg.norm(grad_V_actuated @ J)
#                 * q_quantile
#             )
...
#             robustness_cost = (
#                 np.linalg.norm(grad_V_actuated)
#                 * q_quantile
#             )
